!(function (e, t) {
    ...
    return (
      ...
      (g = ie.select =
        function (e, t, n, i) {
          ...
          return (
            (u || f(e, c))(i, t, !y, n, (Z.test(e) && de(t.parentNode)) || t), n
          );
        }),
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      find: function (e) {
        ...
        return (
          ((n = this.pushStack(1 < r ? C.unique(n) : n)).selector = this
            .selector
            ? this.selector + " " + e
            : e),
          n
  ...
  C.extend({
    dir: function (e, t, n) {
      for (
        ...
        r &&
        9 !== r.nodeType &&
        (void 0 === n || 1 !== r.nodeType || !C(r).is(n));
      ...
      function (i, r) {
        C.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (S[i] || (n = C.unique(n)), E.test(i) && (n = n.reverse())),
            this.pushStack(n)
          );
        };
      }
  ...
  (C.Callbacks = function (r) {
    ...
    var i,
      ...
      f = function (e) {
        for (
          t = r.memory && e, o = !0, s = l || 0, l = 0, a = u.length, i = !0;
          u && s < a;
          s++
        )
    ...
    (C.ready.promise = function (e) {
      if (!L)
        if (((L = C.Deferred()), "complete" === N.readyState))
          setTimeout(C.ready);
  ...
  (v.ownLast = "0" !== _),
    ...
    C(function () {
      ...
      (n = N.getElementsByTagName("body")[0]) &&
        ...
        ((i = N.createElement("div")).style.cssText =
  ...
  C.extend({
    ...
    C.fn.extend({
      data: function (e, t) {
        ...
        if (
          this.length &&
          ((r = C.data(o)), 1 === o.nodeType && !C._data(o, "parsedAttrs"))
        ) {
          for (n = a.length; n--; )
            a[n] &&
              0 === (i = a[n].name).indexOf("data-") &&
              B(o, (i = C.camelCase(i.slice(5))), r[i]);
  ...
  (C.event = {
    ...
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !l.noBubble && !C.isWindow(n)) {
          for (
            s = l.delegateType || d, Q.test(s + d) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            f.push(a), (u = a);
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[r] = a =
            Y.test(r) ? this.mouseHooks : J.test(r) ? this.keyHooks : {}),
    ...
    simulate: function (e, t, n, i) {
      ...
      i ? C.event.trigger(r, null, t) : C.event.dispatch.call(t, r),
      ...
      C.each({ focus: "focusin", blur: "focusout" }, function (n, i) {
        ...
        C.event.special[i] = {
          ...
          teardown: function () {
            ...
            t
              ? C._data(e, i, t)
              : (e.removeEventListener(n, r, !0), C._removeData(e, i));
          },
        };
      }),
    C.fn.extend({
  ...
  function ve(e, t) {
    ...
    if (!o)
      for (o = [], n = e.childNodes || e; null != (i = n[r]); r++)
        !t || C.nodeName(i, t) ? o.push(i) : C.merge(o, ve(i, t));
  ...
  (me.optgroup = me.option),
    ...
    C.extend({
      clone: function (e, t, n) {
        ...
        if (
          (v.html5Clone || C.isXMLDoc(e) || !re.test("<" + e.nodeName + ">")
            ? (o = e.cloneNode(!0))
          ...
          for (i = ve(o), s = ve(e), a = 0; null != (r = s[a]); ++a)
            i[a] && Ne(r, i[a]);
        if (t)
          if (n)
            for (s = s || ve(e), i = i || ve(o), a = 0; null != (r = s[a]); a++)
              Ce(r, i[a]);
          else Ce(e, o);
        return (
          0 < (i = ve(o, "script")).length && Te(i, !l && ve(e, "script")),
          (i = s = r = null),
          o
        );
      },
      buildFragment: function (e, t, n, i) {
        for (
          var r, o, a, s, l, u, c, f = e.length, d = te(t), p = [], h = 0;
          h < f;
          h++
        )
          if ((o = e[h]) || 0 === o)
            if ("object" === C.type(o)) C.merge(p, o.nodeType ? [o] : o);
              ...
              if (
                ...
                for (
                  ...
                  C.nodeName((u = o.childNodes[r]), "tbody") &&
                    !u.childNodes.length &&
                    o.removeChild(u);
    ...
    C.fn.extend({
      ...
      remove: function (e, t) {
        for (
          var n, i = e ? C.filter(e, this) : this, r = 0;
          null != (n = i[r]);
          r++
        )
      ...
      domManip: function (n, i) {
        ...
        if (
          ...
          for (r = (o = C.map(ve(s, "script"), be)).length; l < u; l++)
            (t = s),
              l !== f &&
                ((t = C.clone(t, !0, !0)), r && C.merge(o, ve(t, "script"))),
              i.call(this[l], t, l);
          if (r)
            for (
      ...
      function i() {
        ...
        (t = N.getElementsByTagName("body")[0]) &&
          ...
          h.getComputedStyle &&
            ...
            ((i = e.appendChild(N.createElement("div"))).style.cssText =
              e.style.cssText =
  ...
  function Ie(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), i = t, r = ze.length;
      r--;
      ...
      (i = e[a]).style &&
        ...
        t
          ? (o[a] || "none" !== n || (i.style.display = ""),
            "" === i.style.display &&
              I(i) &&
              (o[a] = C._data(i, "olddisplay", Le(i.nodeName))))
          : ((r = I(i)),
            ((n && "none" !== n) || !r) &&
              C._data(i, "olddisplay", r ? n : C.css(i, "display"))));
    for (a = 0; a < s; a++)
      (i = e[a]).style &&
  ...
  function Ve(e, t, n, i, r) {
    for (
      ...
      "margin" === n && (a += C.css(e, n + z[o], !0, r)),
        i
          ? ("content" === n && (a -= C.css(e, "padding" + z[o], !0, r)),
            "margin" !== n && (a -= C.css(e, "border" + z[o] + "Width", !0, r)))
          : ((a += C.css(e, "padding" + z[o], !0, r)),
            "padding" !== n &&
              (a += C.css(e, "border" + z[o] + "Width", !0, r)));
    return a;
  }
  function Je(e, t, n) {
    var i = !0,
    ...
    if (r <= 0 || null == r) {
      if (
        (((r = De(e, t, o)) < 0 || null == r) && (r = e.style[t]), qe.test(r))
      )
        return r;
  ...
  C.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          ("string" === (o = typeof n) &&
            (r = Re.exec(n)) &&
            ((n = (r[1] + 1) * r[2] + parseFloat(C.css(e, t))), (o = "number")),
          null != n &&
            n == n &&
    ...
    css: function (e, t, n, i) {
      ...
      return (
        ...
        "" === n || n
          ? ((r = parseFloat(o)), !0 === n || C.isNumeric(r) ? r || 0 : o)
          : o
      );
    },
  }),
          ...
          return Ue(
            ...
            n
              ? Ve(
                  ...
                  r,
                  n,
                  v.boxSizing && "border-box" === C.css(e, "boxSizing", !1, i),
                  i
                )
              : 0
          );
      ...
      (C.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          (((n.zoom = 1) <= t || "" === t) &&
            ...
            (n.filter = Fe.test(o) ? o.replace(Fe, r) : o + " " + r);
        },
      }),
    ...
    at = [
      function (t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          (u = C.css(t, "display")),
          "inline" ===
            ("none" === u ? C._data(t, "olddisplay") || Le(t.nodeName) : u) &&
            "none" === C.css(t, "float") &&
            (v.inlineBlockNeedsLayout && "inline" !== Le(t.nodeName)
              ? (d.zoom = 1)
        ...
        if (C.isEmptyObject(f))
          "inline" === ("none" === u ? Le(t.nodeName) : u) && (d.display = u);
        else
          for (i in (h
      ...
      "*": [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a =
              (C.cssNumber[e] || ("px" !== o && +i)) &&
              rt.exec(C.css(n.elem, e)),
            s = 1,
            l = 20;
          if (a && a[3] !== o)
            for (
  ...
  function ct(e, t, n) {
    for (
      var i, r = (st[t] || []).concat(st["*"]), o = 0, a = r.length;
      o < a;
      o++
    )
  ...
  (C.Animation = C.extend(ft, {
    tweener: function (e, t) {
      for (
        var n,
          i = 0,
          r = (e = C.isFunction(e) ? ((t = e), ["*"]) : e.split(" ")).length;
        i < r;
        i++
      )
      ...
      attr: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === M
            ...
            : ((1 === o && C.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (i = C.attrHooks[t] || (C.expr.match.bool.test(t) ? ht : pt))),
              void 0 === n
    ...
    toggleClass: function (r, t) {
      ...
      return "boolean" == typeof t && "string" === o
        ...
        : this.each(function () {
            if ("string" === o)
              for (
                var e, t = 0, n = C(this), i = r.match(A) || [];
                (e = i[t++]);
    ...
    C.each(["get", "post"], function (e, r) {
      C[r] = function (e, t, n, i) {
        return (
          ...
          C.ajax({ url: e, type: r, dataType: i, data: t, success: n })
        );
      };
    }),
    C.each(
      ...
      for (
        d(p).scroll(
          d.proxy(function () {
            var e = d(p).scrollTop();
            i < e
              ? (t.addClass(this.options.fixedHeader),
                n.addClass(this.options.jumboScroll))
              : (t.removeClass(this.options.fixedHeader),
                n.removeClass(this.options.jumboScroll));
          }, this)
        ),
          e.click(function () {
            if (
              ...
              var e = d(this.hash);
              if (
                (e = e.length ? e : d("[name=" + this.hash.slice(1) + "]"))
                  .length
              )
                return (
                  d("html,body").animate({ scrollTop: e.offset().top }, 1e3), !1
                );
            }
          }),
          l = 0;
        ...
        d.proxy(function () {
          ...
          for (l = 0; l < f.length; l += 1) {
            var o = f[l],
              ...
              s = d(o).height();
            a <= e && e < a + s
              ? c.filter("[href='" + o + "']").addClass(this.options.activeLink)
              : c
                  .filter("[href='" + o + "']")
  ...
  (function (i, e, t, n) {
    ...
    (o.prototype.init = function () {
      var e = i(this.element),
        ...
        n =
          (i("." + this.options.itemHidden),
          e.find("." + this.options.filterLink));
      ...
      n.on("click", function () {
        if (!i(this).hasClass("is-selected")) {
          ...
          t.each(function () {
            ...
            i(this).is("[data-cat*=" + e + "]")
              ? i(this).removeClass("is-hidden")
              : i(this).addClass("is-hidden");
          });
        }
        return !1;
      });
